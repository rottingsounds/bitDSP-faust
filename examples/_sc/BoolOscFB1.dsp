...
oscfb1 = loop ~ _ with {
    loop(fb) = leakdc(0.9999, bool_osc1_mod(
        10 + max(0, fb * 10000 * d1),
        10 + max(0, fb * 10000 * d2)
    ));
};
oscfb2 = loop ~ _ with {
    loop(fb) = leakdc(0.9999, bool_osc2_mod(
